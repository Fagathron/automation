...
import alex.pageobjects.LandingPage;
...
public class BaseTest {
    ...
    public WebDriver initializeDriver() throws IOException {
        ...
        FileInputStream fis = new FileInputStream(System.getProperty("user.dir") + "/src/main/java/alex/resources/GlobalData.properties");
        property.load(fis);
        ...
        if(browserName.contains("chrome")) {
            ...
            //to make sure headless runs in full screen
    ...
    public LandingPage lunchApp() throws IOException {
